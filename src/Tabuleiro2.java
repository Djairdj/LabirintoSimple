public class Tabuleiro2 {
    private static final int QNT_LINHAS = 20;
    ...
    private static final float PROBABILIDADE = 0.6f;
    ...
    private static boolean tentarCaminho(int proxLinha, int proxColuna, String simbolo) {
        ...
        if (tabuleiro[proxLinha][proxColuna].equals(ajuste(DESTINO))) {
            tabuleiro[proxLinha][proxColuna] = ajuste("۞");
            deuCerto = true;
    ...
    public static void main(String[] a) {
        start();
        System.out.printf("Ocorreram %d recursões.\n", recursiva);
    }
}
